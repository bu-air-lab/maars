...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class PizzaVendorController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            delivery_plan = plannerScript.pizza_vendor_entire_plans;
            drop_plan = plannerScript.pizza_vendor_drops_plans;
            current_random_plan = plannerScript.pizzas_vendor_random_plan;
